...
[![AUR](https://img.shields.io/badge/license-Apache%20License%202.0-blue.svg)](https://github.com/bmsoft/bmsoft-admin-cloud/blob/master/LICENSE)
[![](https://img.shields.io/badge/Author-bmsoft-orange.svg)](https://github.com/bmsoft/bmsoft-admin-cloud)
[![](https://img.shields.io/badge/version-1.0-brightgreen.svg)](https://github.com/bmsoft/bmsoft-admin-cloud)
[![GitHub stars](https://img.shields.io/github/stars/bmsoft/bmsoft-admin-cloud.svg?style=social&label=Stars)](https://github.com/bmsoft/bmsoft-admin-cloud/stargazers)
[![star](https://gitee.com/bmsoft111/bmsoft-admin-cloud/badge/star.svg?theme=white)](https://gitee.com/bmsoft111/bmsoft-admin-cloud/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/bmsoft/bmsoft-admin-cloud.svg?style=social&label=Fork)](https://github.com/bmsoft/bmsoft-admin-cloud/network/members)
[![fork](https://gitee.com/bmsoft111/bmsoft-admin-cloud/badge/fork.svg?theme=white)](https://gitee.com/bmsoft111/bmsoft-admin-cloud/members)
...
|---|---|---|---|---|
| NONE | 无 | 无 | 支持 | bmsoft_defaults | 
| COLUMN | 有 | 无 | 支持 | bmsoft_defaults |
| SCHEMA | 无 | 无 | 支持 | bmsoft_defaults、bmsoft_base_{tenant} |
| DATASOURCE | 无 | 无 | 支持 | bmsoft_defaults、bmsoft_base_{tenant} |
...
## 详细文档: https://www.kancloud.cn/bmsoft/bmsoft-admin-cloud
...
![qq群.png](docs/image/qq群.png) <a target="_blank" href="//shang.qq.com/wpa/qunwpa?idkey=958f380cb111bcea0cfe35cc5996c47b72ae17a3757807599d1f5ad4fa3c4f6b"><img border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="bmsoft-admin-cloud 交流" title="bmsoft-admin-cloud 交流"></a>
...
| 项目 | gitee | github | 备注 |
|---|---|---|---|
| 核心工具类 | https://gitee.com/bmsoft111/bmsoft-commons | https://github.com/bmsoft/bmsoft-commons | cloud和boot 项目都依赖她 |
| 微服务项目 | https://gitee.com/bmsoft111/bmsoft-admin-cloud | https://github.com/bmsoft/bmsoft-admin-cloud | SpringCloud 版本 |
| 单体项目 | https://gitee.com/bmsoft111/bmsoft-admin-boot | https://github.com/bmsoft/bmsoft-admin-boot | SpringBoot 版本 |
| 租户后台 | https://gitee.com/bmsoft111/bmsoft-ui | https://github.com/bmsoft/bmsoft-ui | 给客户使用 |
| 开发&运营后台 | https://gitee.com/bmsoft111/bmsoft-admin-ui | https://github.com/bmsoft/bmsoft-admin-ui | 给公司内部开发&运营&运维等人员使用 |
| 代码生成器 | https://gitee.com/bmsoft111/bmsoft-generator | https://github.com/bmsoft/bmsoft-generator | 给开发人员使用 |

## bmsoft-admin-cloud 演示地址 （服务器没法备案，只能加上端口~~~）

| 项目 | 演示地址 | 管理员账号 | 普通账号 | 
|---|---|---|---|
| 租户后台 | http://tangyh.top:10000/bmsoft-ui/ | bmsoft/bmsoft | test/zuiou |
| 开发&运营后台 | http://tangyh.top:180/bmsoft-admin-ui/ | demoAdmin/bmsoft | 无 |
...
于是，A公司就在 bmsoft-admin-ui（开发&运营后台） 上新建了 租户B 和租户C， 并各自新建了账号b1和账号c1， 分别给B公司和C公司 试用，
B公司和C公司分别拿着账号， 在 bmsoft-ui(租户后台) 上试用， 试用很满意，但土豪B公司先要定制功能， 就跟A公司签了一个500W的定制大单，并要求独立部署在他们自己的服务器 
穷逼C公司没钱， 就花了20W使用A公司部署的云环境， 服务器和数据等都存在A公司的云服务器上。
```

## bmsoft-admin-boot 演示地址 

| 项目 | 演示地址 | 管理员账号 | 普通账号 |
|---|---|---|---|
| 租户后台 | http://42.202.130.216:10000/bmsoft-ui | bmsoft/bmsoft | test/zuiou |
| 开发&运营后台 | http://42.202.130.216:10000/bmsoft-admin-ui | demoAdmin/bmsoft | 无 |
| swagger文档 | http://42.202.130.216:10000/api/gate/doc.html | 无 | 无 |
| 定时任务 | http://42.202.130.216:10000/bmsoft-jobs-server | bmsoft/bmsoft | 无  |
...
11. **前后端统一表单验证**
    ...
    故在`hibernate-validator`的基础上封装了`bmsoft-validator-starter`起步依赖，提供一个通用接口，可以获取需要校验表单的规则，然后前端使用后端返回的规则，
    以后若规则改变，只需要后端修改即可。
...
| ![预览.png](docs/image/1000star.png) | ![预览.png](docs/image/项目相关/bmsoft-jobs-server.png) |
