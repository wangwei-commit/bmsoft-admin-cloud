...
//                        Arrays.asList("f_.*"));
//        build.setUrl("jdbc:mysql://127.0.0.1:3306/bmsoft_file_dev?useUnicode=true&useSSL=false&characterEncoding=utf8");
////        build.setPassword("root");
//        build.setProjectRootPath(System.getProperty("user.dir") + "/bmsoft-backend/bmsoft-file");
//
