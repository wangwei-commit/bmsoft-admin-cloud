...
//                build("msgs", "msgs", "bmsoft",
//                        "",
//                        Arrays.asList("msgs_.*"));
////                        Arrays.asList("c_auth_user_role", "c_auth_role_authority", "c_auth_role_org"));
//        build.setUrl("jdbc:mysql://127.0.0.1:3306/bmsoft_msgs_dev?useUnicode=true&useSSL=false&characterEncoding=utf8");
////        build.setPassword("root");
//        build.setProjectRootPath(System.getProperty("user.dir") + "/bmsoft-backend/bmsoft-msgs");
//
