...
import com.bmsoft.cloud.oauth.api.hystrix.UserApiFallback;
 ...
 * @date 2019/07/02
 */
@FeignClient(name = "${bmsoft.feign.oauth-server:bmsoft-oauth-server}", fallback = UserApiFallback.class
