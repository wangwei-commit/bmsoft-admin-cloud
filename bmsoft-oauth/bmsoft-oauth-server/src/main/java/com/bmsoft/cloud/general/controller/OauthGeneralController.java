package com.bmsoft.cloud.general.controller;
...
import com.bmsoft.cloud.authority.enumeration.common.LogType;
...
import com.bmsoft.cloud.msgs.enumeration.MsgsBizType;
import com.bmsoft.cloud.msgs.enumeration.MsgsCenterType;
import com.bmsoft.cloud.security.annotation.PreAuth;
import com.bmsoft.cloud.sms.enumeration.ProviderType;
import com.bmsoft.cloud.sms.enumeration.SendStatus;
import com.bmsoft.cloud.sms.enumeration.SourceType;
import com.bmsoft.cloud.sms.enumeration.TaskStatus;
...
public class OauthGeneralController {
    ...
    @Value("${bmsoft.database.isNotWrite:false}")
