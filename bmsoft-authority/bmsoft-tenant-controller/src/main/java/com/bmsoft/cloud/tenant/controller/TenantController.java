...
import com.bmsoft.cloud.tenant.dto.TenantUpdateDTO;
...
import static com.bmsoft.cloud.tenant.enumeration.TenantStatusEnum.NORMAL;
...
public class TenantController extends SuperCacheController<TenantService, Long, Tenant, Tenant, TenantSaveDTO, TenantUpdateDTO> {
    ...
    @ApiOperationSupport(author = "bmsoft")
