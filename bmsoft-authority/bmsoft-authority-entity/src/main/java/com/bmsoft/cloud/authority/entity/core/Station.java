package com.bmsoft.cloud.authority.entity.core;
...
import static com.bmsoft.cloud.common.constant.InjectionFieldConstants.ORG_ID_METHOD;
...
public class Station extends Entity<Long> {
    ...
    @Excel(name = "组织")
    @ExcelEntity(name = "")
    private RemoteData<Long, com.bmsoft.cloud.authority.entity.core.Org> org;
