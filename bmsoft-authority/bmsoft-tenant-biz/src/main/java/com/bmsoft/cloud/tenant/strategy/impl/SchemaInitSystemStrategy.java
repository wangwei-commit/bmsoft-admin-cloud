...
import com.bmsoft.cloud.tenant.dao.InitDbMapper;
...
import static com.bmsoft.cloud.common.constant.BizConstant.BASE_DATABASE;

/**
 * 初始化系统
 * <p>
 * 初始化规则：
 * bmsoft-authority-server/src/main/resources/sql 路径存放8个sql文件 (每个库对应一个文件)
 * bmsoft_base.sql            # 基础库：权限、消息，短信，邮件，文件等
 * data_bmsoft_base.sql       # 基础库数据： 如初始用户，初始角色，初始菜单
 *
 * @author bmsoft
 * @date 2019/10/25
 */
