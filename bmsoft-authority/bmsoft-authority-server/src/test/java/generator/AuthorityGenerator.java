...
//        build.setUrl("jdbc:mysql://127.0.0.1:3306/bmsoft_authority_dev?useUnicode=true&useSSL=false&characterEncoding=utf8");
////        build.setPassword("root");
//        build.setProjectRootPath(System.getProperty("user.dir") + "/bmsoft-backend/bmsoft-authority");
//
...
//                        .packagePath("com.bmsoft.cloud.common.enums.HttpMethod").gen(GenerateType.IGNORE).build()
//                , EntityFiledType.builder().name("httpMethod").table("c_auth_resource")
//                        .packagePath("com.bmsoft.cloud.common.enums.HttpMethod").gen(GenerateType.IGNORE).build()
//                , EntityFiledType.builder().name("dsType").table("c_auth_role")
//                        .packagePath("com.bmsoft.cloud.database.mybatis.auth.DataScopeType").gen(GenerateType.IGNORE).build()
//        ));
