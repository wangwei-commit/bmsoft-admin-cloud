...
import com.bmsoft.cloud.authority.dao.common.ParameterMapper;
...
import com.bmsoft.cloud.authority.entity.common.LoginLog;
...
import com.bmsoft.cloud.dozer.DozerUtils;
...
public class TestResource {
    ...
    public void testDict() {
        ...
        Collection<com.bmsoft.cloud.authority.entity.common.Dictionary> dictionaryList = new ArrayList<>();
        dictionaryList.add(com.bmsoft.cloud.authority.entity.common.Dictionary.builder().type("AAA").name("BBBB").build());
