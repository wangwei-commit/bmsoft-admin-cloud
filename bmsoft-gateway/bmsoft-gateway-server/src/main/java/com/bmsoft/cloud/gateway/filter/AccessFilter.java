package com.bmsoft.cloud.gateway.filter;
...
import com.bmsoft.cloud.common.properties.IgnoreTokenProperties;
...
import static com.bmsoft.cloud.context.BaseContextConstants.*;
import static com.bmsoft.cloud.exception.code.ExceptionCode.JWT_OFFLINE;
...
public class AccessFilter implements GlobalFilter, Ordered {
    ...
    @Value("${bmsoft.database.multiTenantType:SCHEMA}")
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        try {
            ...
            if (isDev(token)) {
                authInfo = new AuthInfo().setAccount("bmsoft").setUserId(1L)
