            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" class="form-control" name="type" value="1" maxlength="50">
                        <label for="lastname" class="col-sm-2 control-label">Cron
                            <button class="helpDoc" type="button" style="width:25px;height:22px;">?</button>
                    ...
                    <#--</select>-->
                    <#--</div>-->
                    <#--<label for="lastname" class="col-sm-2 control-label">时间<font color="red">*</font></label>-->
                    <#--<div class="col-sm-4"><input type="text" class="form-control" name="execTime" placeholder="执行时间" maxlength="128" ></div>-->
                    <#--</div>-->
                    <div class="form-group">
...
<#-- trigger -->
<div class="modal fade" id="helpDocModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog ">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" style="text-align:center">Cron常用表达式</h4>
            </div>
        </div>
        <div class="modal-body" style="background: white">
            <form class="form-horizontal form" role="form">
                <div class="form-group">
                    <div class="col-sm-10">*/5 * * * * ? -------------- 每隔5秒执行一次</div>
                    <div class="col-sm-10">0 0/2 * * * ? -------------- 每2分钟执行一次</div>
                    <div class="col-sm-10">0 0 0/1 * * ? -------------- 每个小时整点执行一次</div>
                    <div class="col-sm-10">0 0 12 * * ? --------------- 在每天中午12：00触发</div>
                    <div class="col-sm-10">0 15 10 ? * * --------------- 每天上午10:15 触发</div>
                    <div class="col-sm-10"><a href="http://cron.qqe2.com/" target="_blank">更多</a></div>
                </div>
                <hr>
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-6" style="text-align:center">
                        <button type="button" class="btn" data-dismiss="modal">${I18n.system_cancel}</button>
                    </div>
                </div>
            </form>
        </div>
