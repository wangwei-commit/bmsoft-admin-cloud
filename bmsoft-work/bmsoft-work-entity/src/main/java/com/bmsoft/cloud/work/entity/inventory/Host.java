...
@TableName("inventory_host")
@ApiModel(value = "Host", description = "清单主机")
@AllArgsConstructor
public class Host extends Entity<Long> {
	...
	@Builder
	public Host(Long id, LocalDateTime createTime, Long createUser, LocalDateTime updateTime, Long updateUser,
