...
//        build.setUrl("jdbc:mysql://127.0.0.1:3306/bmsoft_demo_dev?useUnicode=true&useSSL=false&characterEncoding=utf8");
////        build.setPassword("root");
//        build.setProjectRootPath(System.getProperty("user.dir") + "/bmsoft-backend/bmsoft-order");
//
...
////                EntityFiledType.builder().name("httpMethod").packagePath("com.bmsoft.cloud.common.enums.HttpMethod").gen(GenerateType.IGNORE).build()
//        ));
