package com.bmsoft.cloud.order.controller;

import com.bmsoft.cloud.base.R;
import com.bmsoft.cloud.demo.entity.Product;
import com.bmsoft.cloud.order.api.DemoTestApi;
...
public class SeataTxController {
     ...
     * <p>
     * 2，insert into bmsoft_base_0000.m_product 语法，还是无法回滚， 想要测试，请勿在请求头中传递 tenant 参数，并将m_product表和m_order 表复制到 bmsoft_defaults
     *
     * @param
     * @return
     */
